...
namespace CYCommon.HOOK
{
    ...
    public abstract class GlobalHook
    {
        ...
        public void Start()
        {
            if (!_isStarted && _hookType != 0)
            {
                ...
                //_handleToHook = SetWindowsHookEx(_hookType, _hookCallback, (IntPtr)Kernel.LoadLibrary("user32.dll"), 0);
    ...
    /// </summary>
    public class CHkKeyboardHook : GlobalHook
    {
        #region Events
    ...
    /// </summary>
    public class CHkMouseHook : GlobalHook
    {
